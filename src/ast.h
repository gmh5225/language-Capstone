...
class TypeIdentifier : public Node {
  public:
    ...
    TypeIdentifier(std::vector<Node*> children, const std::string& name,
                   unsigned int list, unsigned int final)
        : children(children), name(name), list(list), final(final) {
    }
    std::string toJSON(void);
};
...
class VariableDeclaration : public Node {
  public:
    ...
    VariableDeclaration(Node* type, Node* name, Node* value)
...
class ForStatement : public Node {
  public:
    ...
    ForStatement(Node* init, Node* condition, Node* post, Node* block)
...
class FunctionDeclaration : public Node {
  public:
    ...
    FunctionDeclaration(Node* name, Node* generic, std::vector<Node*> params,
                        std::vector<Node*> returns, Node* block)
        : name(name), generic(generic), params(params), returns(returns),
          block(block) {
    }
    std::string toJSON(void);
};
...
class TernaryExpression : public Node {
  public:
    ...
    TernaryExpression(Node* condition, Node* ifExpression, Node* elseExpression)
        : condition(condition), ifExpression(ifExpression),
...
class ClassDeclaration : public Node {
  public:
    ...
    ClassDeclaration(Node* name, Node* super, Node* body)
        : name(name), super(super), body(body) {
    }
    std::string toJSON(void);
};
...
class ClassVisibility : public Node {
  public:
    ...
    ClassVisibility(Node* member, unsigned int visibility)
        : member(member), visibility(visibility) {
    }
    std::string toJSON(void);
};
