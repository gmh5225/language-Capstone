...
std::string BinaryOperator::toJSON(void) {
    return "{\"_type\": \"BinaryOperator\",\"left\": " + left->toJSON() +
           ",\"right\": " + right->toJSON() +
           ",\"op\":" + Lexer::getTokenStr(op) + ",}";
}

std::string FunctionCall::toJSON(void) {
    return "{\"_type\": \"FunctionCall\",\"callback\": " + callback->toJSON() +
...
std::string VariableIdentifier::toJSON(void) {
    return "{\"_type\": \"VariableIdentifier\",\"child\": " + child->toJSON() +
           ",\"name\":" + name + ",}";
}

std::string TypeIdentifier::toJSON(void) {
    return "{\"_type\": \"TypeIdentifier\",\"name\":" + name + ",}";
}

std::string VariableAssignment::toJSON(void) {
    return "{\"_type\": \"VariableAssignment\",\"type\": " + type->toJSON() +
           ",\"name\": " + name->toJSON() + ",\"value\": " + value->toJSON() +
           ",}";
}

std::string VariableReassignment::toJSON(void) {
    return "{\"_type\": \"VariableReassignment\",\"op\":" +
           Lexer::getTokenStr(op) + ",\"name\": " + name->toJSON() +
           ",\"value\": " + value->toJSON() + ",}";
}
