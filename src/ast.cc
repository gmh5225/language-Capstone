...
std::string UnaryOperator::toJSON(void) {
    return "{\"_type\": \"UnaryOperator\",\"element\": " +
           nullSafeToString(element) + ",\"op\": \"" + Lexer::getTokenStr(op) +
           "\"}";
}

std::string BinaryOperator::toJSON(void) {
    return "{\"_type\": \"BinaryOperator\",\"left\": " +
           nullSafeToString(left) + ",\"right\": " + nullSafeToString(right) +
           ",\"op\": \"" + Lexer::getTokenStr(op) + "\"}";
}

std::string FunctionCall::toJSON(void) {
    return "{\"_type\": \"FunctionCall\",\"callback\": " +
           nullSafeToString(callback) +
           ",\"generic\": " + nullSafeToString(generic) +
           ",\"params\": " + createList(params) + "}";
}

std::string NumberLiteral::toJSON(void) {
    return "{\"_type\": \"NumberLiteral\",\"literal\": \"" +
           safeLiterals(literal) + "\"}";
}

std::string StringLiteral::toJSON(void) {
    return "{\"_type\": \"StringLiteral\",\"literal\": \"" +
           safeLiterals(literal) + "\"}";
}

std::string BooleanLiteral::toJSON(void) {
    return "{\"_type\": \"BooleanLiteral\",\"literal\": \"" +
           safeLiterals(literal) + "\"}";
}
...
std::string VariableIdentifier::toJSON(void) {
    return "{\"_type\": \"VariableIdentifier\",\"child\": " +
           nullSafeToString(child) + ",\"name\": \"" + safeLiterals(name) +
           "\"}";
}

std::string TypeIdentifier::toJSON(void) {
    return "{\"_type\": \"TypeIdentifier\",\"children\": " +
           createList(children) + ",\"name\": \"" + safeLiterals(name) +
           "\",\"list\": \"" + std::to_string(list) + "\",\"final\": \"" +
           std::to_string(final) + "\"}";
}

std::string VariableDeclaration::toJSON(void) {
    return "{\"_type\": \"VariableDeclaration\",\"type\": " +
           nullSafeToString(type) + ",\"name\": " + nullSafeToString(name) +
           ",\"value\": " + nullSafeToString(value) + "}";
}

std::string ExpressionStatement::toJSON(void) {
    return "{\"_type\": \"ExpressionStatement\",\"expression\": " +
           nullSafeToString(expression) + "}";
}
...
std::string IfElseStatement::toJSON(void) {
    return "{\"_type\": \"IfElseStatement\",\"condition\": " +
           nullSafeToString(condition) +
           ",\"ifBlock\": " + nullSafeToString(ifBlock) +
           ",\"elseBlock\": " + nullSafeToString(elseBlock) + "}";
}

std::string WhileStatement::toJSON(void) {
    return "{\"_type\": \"WhileStatement\",\"condition\": " +
           nullSafeToString(condition) +
           ",\"block\": " + nullSafeToString(block) + "}";
}

std::string ForStatement::toJSON(void) {
    return "{\"_type\": \"ForStatement\",\"init\": " + nullSafeToString(init) +
           ",\"condition\": " + nullSafeToString(condition) +
           ",\"post\": " + nullSafeToString(post) +
           ",\"block\": " + nullSafeToString(block) + "}";
}

std::string ParameterDeclaration::toJSON(void) {
    return "{\"_type\": \"ParameterDeclaration\",\"type\": " +
           nullSafeToString(type) + ",\"name\": " + nullSafeToString(name) +
           "}";
}

std::string FunctionDeclaration::toJSON(void) {
    return "{\"_type\": \"FunctionDeclaration\",\"name\": " +
           nullSafeToString(name) +
           ",\"generic\": " + nullSafeToString(generic) +
           ",\"params\": " + createList(params) +
           ",\"returns\": " + createList(returns) +
           ",\"block\": " + nullSafeToString(block) + "}";
}
...
std::string ReturnStatement::toJSON(void) {
    return "{\"_type\": \"ReturnStatement\",\"expressions\": " +
           createList(expressions) + "}";
}

std::string ImportStatement::toJSON(void) {
    return "{\"_type\": \"ImportStatement\",\"package\": " +
           nullSafeToString(package) + "}";
}

std::string TernaryExpression::toJSON(void) {
    return "{\"_type\": \"TernaryExpression\",\"condition\": " +
           nullSafeToString(condition) +
           ",\"ifExpression\": " + nullSafeToString(ifExpression) +
           ",\"elseExpression\": " + nullSafeToString(elseExpression) + "}";
}

std::string ClassDeclaration::toJSON(void) {
    return "{\"_type\": \"ClassDeclaration\",\"name\": " +
           nullSafeToString(name) + ",\"super\": " + nullSafeToString(super) +
           ",\"body\": " + nullSafeToString(body) + "}";
}

std::string ClassVisibility::toJSON(void) {
    return "{\"_type\": \"ClassVisibility\",\"member\": " +
           nullSafeToString(member) + ",\"visibility\": \"" +
